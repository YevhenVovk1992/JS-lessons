...
Основная задача - это написать функцию isBudgetEnough, которая буде возвращать строку. Если бюджета хватает для отопления всего объема торгового центра - 
...
function isBudgetEnough(data) {
    ...
    data.shops.forEach(element => {       
        allArea += element.width * element.length;
    });
    totalVolume = allArea * data.height;
    (totalVolume * data.moneyPer1m3) <= data.budget ? isEnough = true : isEnough = false;
